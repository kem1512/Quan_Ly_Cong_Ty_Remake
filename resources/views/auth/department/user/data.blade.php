@if ($users->count() > 0)
    @foreach ($users as $user)
        <tr>
            ...
            <td>
                <button class="btn btn-danger m-0" id="offcanvas" data-id="{{ $user->id }}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">Xem</button>
                @if ($user_max == true)
