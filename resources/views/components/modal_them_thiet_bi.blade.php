 ...
 <div class="offcanvas offcanvas-end w-25" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
     <div class="offcanvas-header">
         <h5 class="offcanvas-title" id="offcanvasRightLabel">Nhập kho</h5>
     ...
     <div class="offcanvas-body">
         <form id="form-equiment">
                         ...
                         <div class="mt-2">
                             ...
                             <select name="supplier_id" class="form-control">
                                 @foreach ($list_kho as $item)
                                     <option value="{{ $item->id }}"><img src="{{ $item->image }}" alt="">
                                         {{ $item->name }}</option>
                                 @endforeach
                             </select>
                         </div>
             ...
             <div class="modal-footer">
                 <button type="button" class="btn btn-secondary" id="btnHuy"><i class="fa-solid fa-x"></i></button>
